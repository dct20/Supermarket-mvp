...
namespace Supermarket_mvp.Models
{
    internal class CustomerModel
    {
        ...
        [StringLength(50, MinimumLength = 4, ErrorMessage = "Customer First Name must be between 3 and 50 Charaters")]
        public string First_Name { get; set; }


        [DisplayName("Customer Last Name")]
        [Required(ErrorMessage = "Customer Last Name is required")]
        [StringLength(80, MinimumLength = 3, ErrorMessage = "Customer Last Name must be between 3 and 50 characters")]
